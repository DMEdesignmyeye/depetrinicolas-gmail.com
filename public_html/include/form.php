...
$toemails[] = array(
				'email' => 'info@dmedigital.com.ar', // Your Email Address
				'name' => 'DME Digital' // Your Name
			);
...
$fromemail = array(
				'email' => 'no-reply@DMEDigital.com.ar', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'DME Digital' // Company Name
			);
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$message = array(
		'success'			=> '<strong>Gracias</strong> hemos recibido su mensaje.',
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . ' <strong>DME Digital</strong>. All Rights Reserved.';

	$mail->Subject = !empty( $submits['subject'] ) ? $submits['subject'] : 'Enviado De DME DIgital';
